    ...
    <div class="container">
        <header>
            ...
            <nav>
                <ul class="menu">
                    <!-- Botón de alertas -->
                    <li><a class="nav-link" href="#"><i class='bx bx-bell bx-sm bx-tada-hover text-primary'></i></a>
                    </li>
                    <!-- Botón para generar código QR -->
                    <li><button class="nav-link" onclick="generarQR()"><i
                                class='bx bx-qrcode bx-sm bx-tada-hover text-primary'></i></button></li>
                    <!-- Botón para cambiar entre temas claro y oscuro -->
                    <li><button class="tema-btn" onclick="toggleTema()"><i class='bx bx-sun bx-sm'></i><i
                                class='bx bx-moon bx-sm'></i></button></li>
                    ...
                    <!-- Botón para salir -->
                    <li><button class="salir-btn" onclick="location.href = 'logout.php';"><i
                                class='bx bx-log-out bx-sm bx-tada-hover text-primary'></i></button></li>
                    </li>
                </ul>
            </nav>
        </header>
        <main>
            ...
            <div class="owl-carousel owl-theme">
                ...
                <div class="item-carousel"><img src="https://seeklogo.com/images/H/hp-logo-EEECF99DCE-seeklogo.com.png"
                        alt="HP"></div>
                <div class="item-carousel"><img
                        src="https://seeklogo.com/images/M/microsoft-office-365-logo-C06AEBE075-seeklogo.com.png"
                        alt="Office 365"></div>
                <div class="item-carousel"><img
                        src="https://seeklogo.com/images/D/dell-logo-49B6BF5FC9-seeklogo.com.png" alt="dell"></div>
                <div class="item-carousel"><img
                        src="https://seeklogo.com/images/L/lenovo-logo-E125AE3250-seeklogo.com.png" alt="Lenovo"></div>
                <div class="item-carousel"><img
                        src="https://seeklogo.com/images/L/linux-logo-3793382FC8-seeklogo.com.png" alt="Linux"></div>
                <div class="item-carousel"><img
                        src="https://seeklogo.com/images/L/logitech-logo-376B7C6FCC-seeklogo.com.png" alt="Logitech">
                </div>
                <div class="item-carousel"><img
                        src="https://seeklogo.com/images/S/spotify-2015-logo-560E071CB7-seeklogo.com.png" alt="spotify">
                </div>
            </div>
        </main>
        <footer>
