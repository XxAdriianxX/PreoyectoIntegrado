...
class PublicacionesUsurario extends Conexion
{
        ...
        if ($this->usuarioLogueado()) {
            ...
            if ($rutaArchivo) {
                if ($this->guardarImagenBaseDeDatos($rutaArchivo, $DNI)) {
                    echo "Publicacion subida exitosamente.";
                }
            }
        }
    }
    ...
    //Hay un error en las claves de la base de datos que hace que a la hora de insertar de un error, pero los comentarios se insertan igual
