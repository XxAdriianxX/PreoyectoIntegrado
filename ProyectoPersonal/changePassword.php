...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST["contraseña"])) {
        $sec->changePassword($_POST["contraseña"]);
    }
}
...
<head>
    ...
    <style>
        body {
            ...
            height: 100vh;
            /*Hace que ocupe el 100% de la pantalla*/
        }
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="password" class="form-control" id="contraseña"
                                                name="contraseña" placeholder="Ingrese la nueva contraseña" required
                                                maxlength="16" minlength="12">
                                        </div>
                                        <br>
                                        <button type="submit" class="btn btn-success btn-block">Cambiar
                                            Contraseña</button>
                                        <br>
                                        <br>
