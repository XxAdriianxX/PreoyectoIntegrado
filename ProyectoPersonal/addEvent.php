                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    <label for="nombre" class="form-label">
                                                        Nombre:</label>
                                                    <input type="text" class="form-control text-muted" id="nombre"
                                                        name="nombre" value="Nombre del evento">
                                                </div>
                                            </div>
                                            <div class="col-md-4 offset-2">
                                                <div class="mb-3">
                                                    <label for="fecha" class="form-label">
                                                        Fecha:</label>
                                                    <input type="text" class="form-control text-muted" id="fecha"
                                                        name="fecha" value="01/01/2024">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    <label for="ubicacion" class="form-label">
                                                        Ubicación:</label>
                                                    <input type="text" class="form-control text-muted" id="ubicacion"
                                                        name="ubicacion" value="Parque Natural de L'Albufera ">
                                                </div>
                                            </div>
                                            <div class="col-md-4 offset-2">
                                                <div class="mb-3">
                                                    <label for="hora" class="form-label">
                                                        Hora:</label>
                                                    <input type="text" class="form-control text-muted" id="hora"
                                                        name="hora" value="17:00">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mb-4">
                                            <div class="col-md-6">
                                                <label for="descripcion" class="form-label">
                                                    Deescripción:</label>
                                                <textarea class="form-control text-muted" rows="3" id="descripcion"
                                                    name="descripcion" placeholder="Describe tu evento"></textarea>
                                            </div>
