                            ...
                            <img src="Assets/img/risa_incontenible.jpg" class="border border-light rounded-circle bg-light m-2 p-2" width="200px" height="180px">
                                <div class= "card fondo custom-bg">
                                    <div class="card-body">
                                        ...
                                        <span class="custom-span badge rounded-pill border border-dark flex-grow-1 text-dark mb-2 ">Javier Zapata</span>
                                        <span class="custom-span badge rounded-pill border border-dark flex-grow-1 text-dark mb-2">Jorge Esteve</span>
                                        <span class="custom-span badge rounded-pill border border-dark flex-grow-1 text-dark mb-2">Beto Da silva</span>
                                        <span class="custom-span badge rounded-pill border border-dark flex-grow-1 text-dark mb-2">Manuel Rosa</span>
                                    </div>
                                </div>
                            </div>
